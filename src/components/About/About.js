...
import { about, about__subtitle } from "./About.module.scss";
        ...
        <Section anchorName={anchorName} title="О нас" isHiddenOvf={true}>
            {
                <div className={about}>
                    <div>
                        ...
                        <h3 className={about__subtitle}>
                            Мы предлагаем нашим клиентам современные инженерные
                            решения в области преобразовательной техники и
                            гибкую ценовую политику.Выбирая ООО НПП «ЦИКЛ ПЛЮС»
                            — Вы экономите своё время, бюджет и будете уверены в
                            успехе Вашего проекта.
                        </h3>
                        <h3 className={about__subtitle}>
                            Выбирая ООО НПП «ЦИКЛ ПЛЮС» — Вы экономите своё
                            время, бюджет и будете уверены в успехе Вашего
                            проекта.
                        </h3>
                    </div>
                    <Gallery />
